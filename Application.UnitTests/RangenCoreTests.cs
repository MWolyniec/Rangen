...
namespace Rangen.Tests
{
    public class RandomGeneratorTests
    {
        ...
        [Test]
        public async Task TheSpecificOccurrencesGeneratedAreRandomAsync()
        {

        }

        [Test]
        public async Task CanGenerateStructureOfOnlyOneOccurrenceAsync()
        {
        }
        [Test]
        public async Task CanGenerateStructureOfTwoOccurrencesAsync()
        {
        ...
        [Test]
        public async Task CanGenerateRandomOccurrenceTreeFromAGivenListOfOccurrences()
        {
        }
